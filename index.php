...
<div class="wrap" wrap-block>
	...
	<div class="tools" tool-spanel>
		...
		<div class="item" ng-class="toolpanel.soundCls" ng-click="soundClick()"></div>
		<div class="item" ng-class="toolpanel.notifCls" ng-click="notifClick()"></div>
...
<div class="dtooltip">
	<span></span>
	<img src="img/tab-close.png" alt="" title="Скрыть это сообщение" />
</div>

<div class="error-notify" title="Закрыть сообщение" error-notify>
	{{errorMessage}}
</div>
